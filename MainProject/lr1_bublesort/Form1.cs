...
namespace lr1_bublesort
{
    public partial class Form1 : Form
    {
        ...
        private void çàÖ³íîþToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            ShellSortByPerNight(rooms);
            DisplayDataGridView();
        }

        private void ñîðòóâàííÿØåëëàToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void çàÍîìåðîìÊ³ìíàòèToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ShellSortByRoomNumber(rooms);
            DisplayDataGridView();
        }

        private void çàÌ³ñöÿìèToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            ShellSortByCapalsity(rooms);
            DisplayDataGridView();
        }

        private void çàÌ³ñöÿìèToolStripMenuItem4_Click(object sender, EventArgs e)
        {
            QuickSortByCapacity(rooms, 0, rooms.Count - 1);
            DisplayDataGridView();
        }

        private void çàÍîìåðîìÊ³ìíàòèToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            QuickSortByRoomNumber(rooms, 0, rooms.Count - 1);
            DisplayDataGridView();
        }

        private void çàÖ³íîþToolStripMenuItem4_Click(object sender, EventArgs e)
        {
